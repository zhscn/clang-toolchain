...
Version:        21.1.8
Release:        1.el7
Summary:        LLVM/Clang 21 under /opt — static libc++ with dynamic glibc 2.17
...
# Stage1 clang required at %{stage1_prefix} (from Dockerfile.base)
...
cat > %{buildroot}%{install_prefix}/toolchains/centos7-clang21.cmake <<'CMAKE'
...
## CMake toolchain
    cmake -S . -B build \\
      -DCMAKE_TOOLCHAIN_FILE=%{install_prefix}/toolchains/centos7-clang21.cmake
EOF
